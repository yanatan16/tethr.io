...
util.inherits(Tether, events.EventEmitter)
...
Tether.prototype._listen = function() {
  ...
  function proxy(nm, nm2) {
    rtc.on(nm, function () {
      tether.emit.apply(tether, [nm2 || nm].concat(Array.prototype.slice.call(arguments)))
    })
  }
}
...
Peer.prototype._listen = function () {
  ...
  peer._chan.onmessage = function (msg) {
    ...
    peer.emit('message', msg, tether.peer(from))
  }
}
